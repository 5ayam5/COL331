...
# options passed:  -imultiarch x86_64-linux-gnu assembly2.c -mtune=generic
...
.LFB0:
	...
	movl	%edi, -4(%rbp)	# x, x
# assembly2.c:1: int g(int x) { return x + 3; }
	movl	-4(%rbp), %eax	# x, tmp84
	addl	$3, %eax	#, _2
# assembly2.c:1: int g(int x) { return x + 3; }
	popq	%rbp	#
	.cfi_def_cfa 7, 8
...
.LFB1:
	...
	subq	$8, %rsp	#,
	movl	%edi, -4(%rbp)	# x, x
# assembly2.c:2: int f(int x) { return g(x); }
	movl	-4(%rbp), %eax	# x, tmp84
	movl	%eax, %edi	# tmp84,
	call	g	#
# assembly2.c:2: int f(int x) { return g(x); }
